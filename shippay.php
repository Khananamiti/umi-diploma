...
?>
	...
	<main class="main">
		...
		<section class="intro">
			<div class="wrapper">
				<h1 class="intro__title">Доставка и оплата</h1>
			</div>
		</section>
		...
		<section>
			<div class="wrapper-left">
				<h1 class="ship__title">Способы получения заказа:</h1>
				<h2 class="ship__subtitle">1) Самовывоз</h2>
				<p>Адрес магазина в Омске: ул. Степанца, 2</p>
				<p>Режим работы магазина: 10:00 – 20:00 ежедневно.</p>
				<p>Оплата производится по факту получения (способ оплаты: «Наличный расчёт», «Банковская карта»).</p>
				<h2 class="ship__subtitle">2) Экспресс – доставка “Яндекс Go”</h2>
				<p>Бесплатно при заказе от 3000₽ (Если сумма меньше, то 150₽)</p>
				<p>Экспресс – доставка в течении 2-х часов.</p>
				<p>Доступна с 10:00 до 20:00.</p>
				<p>Отправляем после полной оплаты.</p>
				<br>
				<h1 class="ship__title">Правила оплаты и безопасность платежей, конфиденциальность информации:</h1>
				<p>Оплата банковскими картами осуществляется через Альфа-Банк.</p>
				<p>К оплате принимаются карты Visa, MasterCard и платежной системы МИР.</p>
					...
					<div class="equipment__cards">
						...
						<div class="equipment__card">
							<div class="equipment__card-pic">
								<img src="./img/svg/logo-alfa.svg" class="e__img" alt="АльфаБанк">
								<a href="#!" class="equipment__card-link"></a>
							</div>
						</div>

						<div class="equipment__card">
							<div class="equipment__card-pic">
								<img src="./img/svg/logo-mastercard.svg" class="e__img" alt="МастерКарт">
								<a href="#!" class="equipment__card-link"></a>
							</div>
						</div>
						...
						<div class="equipment__card">
							<div class="equipment__card-pic">
								<img src="./img/svg/logo-visa.svg" class="e__img" alt="Виза">
								<a href="#!" class="equipment__card-link"></a>
							</div>
						</div>
						...
						<div class="equipment__card">
							<div class="equipment__card-pic">
								<img src="./img/svg/logo-mir.svg" class="e__img" alt="Мир">
								<a href="#!" class="equipment__card-link"></a>
							</div>
						</div>
				...
				<div class="redline">
					...
					<p>По вопросам оплаты с помощью банковской карты и иным вопросам, связанным с работой сайта, Вы можете обращаться по следующуму телефонам: 79040787859.</p>
					...
					<h1 class="ship__title">Правила возврата товара:</h1>
					...
					<p>Для возврата денежных средств на банковскую карту необходимо заполнить «Заявление о возврате денежных средств», которое высылается по требованию компанией на электронный адрес и оправить его вместе с приложением копии паспорта по адресу umiomsk55@gmail.com</p>
					...
					<p>Для возврата денежных средств по операциям проведенными с ошибками необходимо обратиться с письменным заявлением и приложением копии паспорта и чеков/квитанций, подтверждающих ошибочное списание. Данное заявление необходимо направить по адресу umiomsk55@gmail.com</p>
				...
				<h1 class="ship__title">Контактная информация:</h1>
				<p>Название компании ИП АЧМЕТОВ МАРАТ МАРКСОВИЧ</p>
				<p>ИНН 550410808319</p>
				<p>ОГРН 320554300029157</p>
				<p>Фактический адрес 644009, Омск. обл., Омск, 2-й проезд, 27</p>
				<p>Телефон +7-904-078-78-59</p>
				<p class="pb">e-mail umiomsk55@gmail.com</p>
			</div>			
		</section>
